...
Map<String, dynamic> _$$_RadarrMediaManagementConfigToJson(
  ...
  val['downloadPropersAndRepacks'] =
      _$RadarrProperDownloadTypeEnumMap[instance.downloadPropersAndRepacks]!;
  val['createEmptyMovieFolders'] = instance.createEmptyMovieFolders;
  val['deleteEmptyFolders'] = instance.deleteEmptyFolders;
  val['fileDate'] = _$RadarrFileDateTypeEnumMap[instance.fileDate]!;
  val['rescanAfterRefresh'] =
      _$RadarrRescanAfterRefreshTypeEnumMap[instance.rescanAfterRefresh]!;
