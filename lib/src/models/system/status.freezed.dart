...
RadarrSystemStatus _$RadarrSystemStatusFromJson(Map<String, dynamic> json) {
  return _RadarrSystemStatus.fromJson(json);
}

/// @nodoc
mixin _$RadarrSystemStatus {
  ...
  RadarrRuntimeMode get mode => throw _privateConstructorUsedError;
  String? get branch => throw _privateConstructorUsedError;
  RadarrDatabaseType get databaseType => throw _privateConstructorUsedError;
  String get databaseVersion => throw _privateConstructorUsedError;
  RadarrAuthenticationType get authentication =>
  ...
  RadarrUpdateMechanism get packageUpdateMechanism =>
      throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $RadarrSystemStatusCopyWith<RadarrSystemStatus> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RadarrSystemStatusCopyWith<$Res> {
  factory $RadarrSystemStatusCopyWith(
          RadarrSystemStatus value, $Res Function(RadarrSystemStatus) then) =
      _$RadarrSystemStatusCopyWithImpl<$Res, RadarrSystemStatus>;
  @useResult
  $Res call(
      {String? appName,
      String? instanceName,
      ...
      bool isWindows,
      bool isDocker,
      RadarrRuntimeMode mode,
      String? branch,
      RadarrDatabaseType databaseType,
      String databaseVersion,
      RadarrAuthenticationType authentication,
      ...
      RadarrUpdateMechanism packageUpdateMechanism,
      String? packageUpdateMechanismMessage});
}

/// @nodoc
class _$RadarrSystemStatusCopyWithImpl<$Res, $Val extends RadarrSystemStatus>
    implements $RadarrSystemStatusCopyWith<$Res> {
  _$RadarrSystemStatusCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_RadarrSystemStatusCopyWith<$Res>
    implements $RadarrSystemStatusCopyWith<$Res> {
  factory _$$_RadarrSystemStatusCopyWith(_$_RadarrSystemStatus value,
          $Res Function(_$_RadarrSystemStatus) then) =
      __$$_RadarrSystemStatusCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? appName,
...
/// @nodoc
class __$$_RadarrSystemStatusCopyWithImpl<$Res>
    extends _$RadarrSystemStatusCopyWithImpl<$Res, _$_RadarrSystemStatus>
    implements _$$_RadarrSystemStatusCopyWith<$Res> {
  __$$_RadarrSystemStatusCopyWithImpl(
      _$_RadarrSystemStatus _value, $Res Function(_$_RadarrSystemStatus) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_RadarrSystemStatus(
      appName: freezed == appName
          ? _value.appName
          : appName // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_RadarrSystemStatus implements _RadarrSystemStatus {
  const _$_RadarrSystemStatus(
      {this.appName,
      this.instanceName,
      this.version,
  ...
  factory _$_RadarrSystemStatus.fromJson(Map<String, dynamic> json) =>
      _$$_RadarrSystemStatusFromJson(json);
  ...
  final bool isDocker;
  @override
  final RadarrRuntimeMode mode;
  @override
  final String? branch;
  @override
  final RadarrDatabaseType databaseType;
  @override
  final String databaseVersion;
  @override
  final RadarrAuthenticationType authentication;
  @override
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_RadarrSystemStatus &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_RadarrSystemStatusCopyWith<_$_RadarrSystemStatus> get copyWith =>
      __$$_RadarrSystemStatusCopyWithImpl<_$_RadarrSystemStatus>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_RadarrSystemStatusToJson(
      this,
    );
  }
}

abstract class _RadarrSystemStatus implements RadarrSystemStatus {
  const factory _RadarrSystemStatus(
      {final String? appName,
      final String? instanceName,
      final String? version,
      ...
      required final RadarrRuntimeMode mode,
      final String? branch,
      required final RadarrDatabaseType databaseType,
      required final String databaseVersion,
      required final RadarrAuthenticationType authentication,
      ...
      final String? packageVersion,
      final String? packageAuthor,
      required final RadarrUpdateMechanism packageUpdateMechanism,
      final String? packageUpdateMechanismMessage}) = _$_RadarrSystemStatus;

  factory _RadarrSystemStatus.fromJson(Map<String, dynamic> json) =
      _$_RadarrSystemStatus.fromJson;
  ...
  bool get isDocker;
  @override
  RadarrRuntimeMode get mode;
  @override
  String? get branch;
  @override
  RadarrDatabaseType get databaseType;
  @override
